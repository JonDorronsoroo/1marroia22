...
public class FlightManager implements FlightManagerInterface {
	...
	public FlightManager() {
		...
		dataMng.storeFlight(f6);

		Flight f7 = new Flight("F7", "Sevilla", "Granada");

		/*
		 * flightsDB.add(f1); flightsDB.add(f2); flightsDB.add(f3); flightsDB.add(f4);
		 * flightsDB.add(f5); flightsDB.add(f6); flightsDB.add(f7);
		 */
	...
	public void bookSmart(ConcreteFlight selectedConcreteFLight, String type){
		 dataMng.bookSmart(selectedConcreteFLight, type);
	}
